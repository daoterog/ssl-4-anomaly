"""This module contains code related to momentum encoder models."""
...
def initialize_momentum_params(online_net: nn.Module, momentum_net: nn.Module):
    """Copies the parameters of the online network to the momentum network. And turns off
    the gradient for the momentum network.
